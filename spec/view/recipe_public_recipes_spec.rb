...
RSpec.describe 'Recipe index page', type: :feature do
  before(:example) do
    ...
    @recipe1 = Recipe.create(user: @user, name: 'recipe1', preparation_time: 1, cooking_time: 1, description: 'description1', public: true)
    @recipe2 = Recipe.create(user: @user, name: 'recipe2', preparation_time: 1, cooking_time: 1, description: 'description2', public: false)
    @user2 = User.create(name: 'Ali', email: 'test@test2.com', password: "password", password_confirmation: "password")
    @recipe3 = Recipe.create(user: @user2, name: 'recipe3', preparation_time: 1, cooking_time: 1, description: 'description1', public: true)
    @recipe4 = Recipe.create(user: @user2, name: 'recipe4', preparation_time: 1, cooking_time: 1, description: 'description2', public: false)
    sign_in @user
